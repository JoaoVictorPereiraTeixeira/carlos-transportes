...
export default function FullWidthTabs() {
  ...
  return (
    <div className={classes.root}>
      ...
      >
        <TabPanel value={value} index={0} dir={theme.direction}> <FormFretesEmpresariais/>    </TabPanel>
        <TabPanel value={value} index={1} dir={theme.direction}> <FormMudancas/>              </TabPanel>
        <TabPanel value={value} index={2} dir={theme.direction}> <FormCarretosFretesComuns/>  </TabPanel>
      </SwipeableViews>
    </div>
  );
}
